...
public class ZoneRestrictionBehavior : IAIBehavior
{
    ...
    {
        var tempZoneRestrictionBehavior = new ZoneRestrictionBehavior(CenterPoint);
        tempZoneRestrictionBehavior.TargetCoordinate = TargetCoordinate;
        tempZoneRestrictionBehavior.Radius = Radius;

        return tempZoneRestrictionBehavior;
    }
}
